export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Manus Computer': 'Forge Computer',
  'Manus is using': 'Forge is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Manus a task to work on...': 'Give Forge a task to work on...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Manus': 'Login to Forge',
  'Register to Manus': 'Register to Forge',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Manus': 'Registration successful! Welcome to Forge',
  ...
  'You are viewing a completed Manus task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed Forge task. Replay will start automatically in {countdown} seconds.',
  // Claw Page
  ...
  'Chat Freely via Manus': 'Chat Freely via Forge',
  ...
  'Create Manus Claw': 'Create Forge Claw',
  'One-click OpenClaw deployment by Manus': 'One-click OpenClaw deployment by Forge',
  'Creating...': 'Creating...',
  'Create': 'Create',
