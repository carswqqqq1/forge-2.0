export default {
  ...
  'Launch a task with the right workspace, preset, and model stack already loaded.': 'Launch a task with the right workspace, preset, and model stack already loaded.',
  'Workspace': 'Workspace',
  ...
  '{count} memory items ready': '{count} memory items ready',
  'No memories loaded': 'No memories loaded',
  'Quick launch': 'Quick launch',
  'Start from your defaults and route the task into the right workspace.': 'Start from your defaults and route the task into the right workspace.',
  'No preset instructions applied. Forge will use your saved model defaults and general system behavior.': 'No preset instructions applied. Forge will use your saved model defaults and general system behavior.',
  'No saved memory yet. Add context from Settings > Studio to make Forge feel personalized.': 'No saved memory yet. Add context from Settings > Studio to make Forge feel personalized.',
  'Model Defaults': 'Model Defaults',
  'These values become the starting point for new tasks unless a preset overrides them.': 'These values become the starting point for new tasks unless a preset overrides them.',
  'Workspaces': 'Workspaces',
  'Group sessions by client, project, or operating lane.': 'Group sessions by client, project, or operating lane.',
  'Add Workspace': 'Add Workspace',
  'No workspaces yet. Create one to organize related sessions.': 'No workspaces yet. Create one to organize related sessions.',
  'Description': 'Description',
  'Color': 'Color',
  'Memories': 'Memories',
  'Pin recurring context Forge should keep in mind across future work.': 'Pin recurring context Forge should keep in mind across future work.',
  'Add Memory': 'Add Memory',
  'No saved memory yet. Add team facts, preferences, or recurring context here.': 'No saved memory yet. Add team facts, preferences, or recurring context here.',
  'Agent Presets': 'Agent Presets',
  'Create reusable launch profiles with instructions, model settings, and a default workspace.': 'Create reusable launch profiles with instructions, model settings, and a default workspace.',
  'Add Preset': 'Add Preset',
  'No presets yet. Add one for research, coding, operations, or client-specific work.': 'No presets yet. Add one for research, coding, operations, or client-specific work.',
  'None': 'None',
  'Instructions': 'Instructions',
  'Studio changes are ready to save.': 'Studio changes are ready to save.',
  'Studio is up to date.': 'Studio is up to date.',
  'Reset': 'Reset',
  'Saving...': 'Saving...',
  'Save Studio': 'Save Studio',
  'Studio settings saved': 'Studio settings saved',
  'Failed to save studio settings': 'Failed to save studio settings',
  // Profile Settings
  'Name': 'Name',
