export default {
  ...
  'Language': '语言',
  'Profile': '个人资料',
  'Forge Studio': 'Forge 工作台',
  'Launch a task with the right workspace, preset, and model stack already loaded.': '用合适的工作区、预设和模型配置直接启动任务。',
  'Workspace': '工作区',
  ...
  '{count} memory items ready': '已加载 {count} 条记忆',
  'No memories loaded': '暂无记忆',
  'Quick launch': '快速启动',
  'Start from your defaults and route the task into the right workspace.': '从默认配置开始，并把任务发送到合适的工作区。',
  'No preset instructions applied. Forge will use your saved model defaults and general system behavior.': '当前未应用预设指令。Forge 将使用你保存的默认模型配置和通用系统行为。',
  'No saved memory yet. Add context from Settings > Studio to make Forge feel personalized.': '还没有保存记忆。去“设置 > 工作台”添加上下文，让 Forge 更懂你。',
  'Model Defaults': '默认模型配置',
  'These values become the starting point for new tasks unless a preset overrides them.': '除非被预设覆盖，否则这些值会作为新任务的默认起点。',
  'Workspaces': '工作区',
  'Group sessions by client, project, or operating lane.': '按客户、项目或工作流对会话进行分组。',
  'Add Workspace': '新增工作区',
  'No workspaces yet. Create one to organize related sessions.': '还没有工作区。新建一个来组织相关会话。',
  'Description': '描述',
  'Color': '颜色',
  'Memories': '记忆',
  'Pin recurring context Forge should keep in mind across future work.': '固定 Forge 在后续工作中需要持续记住的上下文。',
  'Add Memory': '新增记忆',
  'No saved memory yet. Add team facts, preferences, or recurring context here.': '还没有保存记忆。可以在这里添加团队事实、偏好或长期上下文。',
  'Agent Presets': 'Agent 预设',
  'Create reusable launch profiles with instructions, model settings, and a default workspace.': '创建可复用的启动配置，包含指令、模型设置和默认工作区。',
  'Add Preset': '新增预设',
  'No presets yet. Add one for research, coding, operations, or client-specific work.': '还没有预设。可以为调研、编码、运营或客户场景创建一个。',
  'None': '无',
  'Instructions': '指令',
  'Studio changes are ready to save.': '工作台改动已准备好保存。',
  'Studio is up to date.': '工作台配置已是最新。',
  'Reset': '重置',
  'Saving...': '保存中...',
  'Save Studio': '保存工作台',
  'Studio settings saved': '工作台设置已保存',
  'Failed to save studio settings': '工作台设置保存失败',
  // Profile Settings
  'Name': '名称',
