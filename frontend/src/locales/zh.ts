export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Manus Computer': 'Forge 的电脑',
  'Manus is using': 'Forge 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give Manus a task to work on...': '给 Forge 一个任务...',
  // Shell tools
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Manus': '登录 Forge',
  'Register to Manus': '注册 Forge',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to Manus': '注册成功！欢迎使用 Forge',
  ...
  'You are viewing a completed Manus task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 Forge 任务。回放将在 {countdown} 秒后自动开始。',
  // Claw Page
  ...
  'Chat Freely via Manus': '通过 Forge 自由对话',
  ...
  'Get Started': '立即开始',
  'Create Manus Claw': '创建 Forge Claw',
  'One-click OpenClaw deployment by Manus': 'Forge 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
  'Create': '创建',
